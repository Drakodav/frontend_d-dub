...
export const getIrelandProjection = (): { proj: Projection } => {
    proj4.defs(
    ...
    const proj = getProjection(destinationProjection);
    ...
    const extent = applyTransform(worldExtent, getTransform('EPSG:4326', proj), undefined, 8);
